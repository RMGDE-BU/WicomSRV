...
begin
  if (bState) then begin
    ...
    // Message über Schließen an Abrufmodule schicken
...
{ Baut Verbindung für Momentanwert-       }
{ darstelllung auf                        }
{ Parameter: T-Aufb., F-Abb.; StationsId  }
{-----------------------------------------}
  ...
  try
    ...
    try
      ...
      while (GetTickCount < iStop) do begin
        Delay(100);
        // Selbständig Haltesatz schreiben
