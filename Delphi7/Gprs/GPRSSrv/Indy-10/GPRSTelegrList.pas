...
uses
  Classes, SysUtils, ComCtrls, ExtCtrls, IdTCPConnection;
...
type
  ...
  TGPRSTelegrData = record
    ...
    ClientConnection: TIdTCPConnection;  // 03.06.2020, WW
  end;
  ...
  public
    ...
    procedure SetTelegramm (ATelegramm: string; AGerTypNr: integer;
      AClientAdresse: string; AClientConnection: TIdTCPConnection);
...
begin
  ...
  GPRSTelegrData.ClientConnection:=AClientConnection;
